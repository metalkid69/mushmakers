        ...
        <main className="min-h-screen bg-stone-50 flex flex-col">
            ...
            <Container className="pt-32 pb-20 flex-grow">
                ...
                <div className="prose prose-stone max-w-none bg-white p-8 rounded-2xl border border-stone-100">
                    ...
                    <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name mushmakers.in ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>

                    <p>The Platform is owned by MushMakers, a company incorporated under the Companies Act, 1956 with its registered office at Patna, Bihar (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</p>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Patna, Bihar.</li>
